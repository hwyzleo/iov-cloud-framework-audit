package net.hwyz.iov.cloud.framework.audit.aspect;
...
import net.hwyz.iov.cloud.framework.audit.enums.BusinessStatus;
import net.hwyz.iov.cloud.framework.audit.filter.PropertyPreExcludeFilter;
import net.hwyz.iov.cloud.framework.audit.service.AsyncLogService;
...
public class LogAspect {
    ...
    protected void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult) {
        try {
            ...
            operLog.setOperUrl(StrUtil.sub(ServletUtil.getRequest().getRequestURI(), 0, 255));
            ...
            if (e != null) {
                ...
                operLog.setErrorMsg(StrUtil.substring(e.getMessage(), 0, 2000));
            }
            // 设置方法名称
